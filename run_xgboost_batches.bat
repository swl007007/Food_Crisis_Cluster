...
echo Running: python main_model_XGB.py --start_year %start_year% --end_year %end_year% --forecasting_scope %forecasting_scope% --force_cleanup

REM Run the Python script with current parameters and force cleanup
python main_model_XGB.py --start_year %start_year% --end_year %end_year% --forecasting_scope %forecasting_scope% --force_cleanup
