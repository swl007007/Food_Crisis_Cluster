@echo off
REM ============================================================================
REM Partitioned (k40_nc4) XGBoost Evaluation - Windows Batch Script
REM ============================================================================
REM
REM This batch file runs the XGBoost evaluation script with default parameters.
REM
REM Usage:
...
REM   run_partition_k40_nc4_comparison_XGB.bat --visual        (with 2 maps, no contiguity)
...
echo.
echo ============================================================================
echo PARTITIONED (k40_nc4) XGBOOST EVALUATION - POOLED BASELINE DISABLED
echo ============================================================================
echo.
...
echo Running XGBoost partitioned evaluation...
echo.
